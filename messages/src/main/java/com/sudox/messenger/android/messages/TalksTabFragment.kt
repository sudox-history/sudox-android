...
import com.sudox.messenger.android.messages.vos.TalkVO
...
class TalksTabFragment : ViewListFragment<DialogsAdapter>(), TabsChildFragment, ApplicationBarListener {
    ...
    fun generateDialog(): TalkVO {
        ...
        val talk_names = listOf("Sudox", "БПИ191 Важное", "Анимэ", "НИДЕРЛАНДЫ")
        ...
        return TalkVO(
                ...
                talkImageId = 4L,
                talkName = talk_names[Random.nextInt(talk_names.size)],
