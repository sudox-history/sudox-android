...
public final class CustomObservableSampleTimed<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    public CustomObservableSampleTimed(ObservableSource<T> source, long period, TimeUnit unit, Scheduler scheduler, boolean emitLast) {
        super(source);
        this.period = period;
        this.unit = unit;
