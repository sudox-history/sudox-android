...
package ru.sudox.android.core.realm.support;
...
public class RealmRxJava3ObservableFactory {
    ...
    public Flowable<Realm> from(Realm realm) {
        ...
        return Flowable.create(new FlowableOnSubscribe<Realm>() {
            ...
            public void subscribe(final FlowableEmitter<Realm> emitter) throws Exception {
                ...
                emitter.setDisposable(Disposable.fromRunnable(new Runnable() {
                    @Override
                    public void run() {
    ...
    public boolean equals(Object o) {
        return o instanceof RealmRxJava3ObservableFactory;
    }
