package com.sudox.messenger.android.media.images
...
import com.sudox.messenger.android.media.images.factories.GlideImagesLoaderFactory
...
class GlideImagesModule : AppGlideModule() {
    ...
    override fun applyOptions(context: Context, builder: GlideBuilder) {
        builder.setDefaultRequestOptions(RequestOptions().format(DecodeFormat.PREFER_ARGB_8888))
                .setSourceExecutor(GlideExecutor.newSourceBuilder()
                        .setName("Sudox Images Thread")
                        .setThreadCount(1)
                        .build()
                )
    }
