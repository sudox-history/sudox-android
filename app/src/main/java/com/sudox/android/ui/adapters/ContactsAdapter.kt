...
class ContactsAdapter(var items: List<Contact>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (items[position].firstColor != null) {
            ...
            holder.avatar.setImageBitmap(setGradientColor(items[position].firstColor!!,
                    items[position].secondColor!!, text))
    ...
    private fun setGradientColor(firstColor: String, secondColor: String, text: String): Bitmap {
        val imageBitmap = Bitmap.createBitmap(300, 300, Bitmap.Config.ARGB_8888)
        ...
        drawTextCentred(imageCanvas, paint, text, 100, (imageBitmap.width / 2).toFloat(), (imageBitmap.height / 2).toFloat())
