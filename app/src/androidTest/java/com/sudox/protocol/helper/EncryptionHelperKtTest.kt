...
class EncryptionHelperKtTest {
    ...
    fun testEncryptAES() {
        ...
        val validResult = "3b1d03e6403841c5379f45dd94ceb8c30025b280f27b9f58"
    ...
    fun testDecryptAES() {
        ...
        val inputTest = "3b1d03e6403841c5379f45dd94ceb8c30025b280f27b9f58"
        ...
        // Encrypt to the RSA
        val encryptedData = decryptAES(key, iv, inputTest)
