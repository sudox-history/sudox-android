...
Java_com_sudox_cipher_Cipher_generateBytes(JNIEnv *env, jclass type, jint length) {
...
Java_com_sudox_cipher_Cipher_generateBase64(JNIEnv *env, jclass type, jint length) {
    SecByteBlock block = generateBytes(static_cast<size_t>(length));
