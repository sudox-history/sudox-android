...
Java_com_sudox_cipher_Cipher_calculateSecretKey(JNIEnv *env, jclass type,
...
Java_com_sudox_cipher_Cipher_generateKeysPair(JNIEnv *env, jclass type) {
    return generateKeysPair();
}

extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_sudox_cipher_Cipher_getPrivateKey(JNIEnv *env, jclass type, jint pairId) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_sudox_cipher_Cipher_getPublicKey(JNIEnv *env, jclass type, jint pairId) {
...
Java_com_sudox_cipher_Cipher_removeAllKeysPairs(JNIEnv *env, jclass type) {
    removeAllKeysPairs();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_sudox_cipher_Cipher_removeKeysPair(JNIEnv *env, jclass type, jint pairId) {
