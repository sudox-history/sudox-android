...
Java_com_sudox_protocol_helpers_CipherHelper_decodeFromBase64(JNIEnv *env, jclass type,
                                                              jbyteArray encoded) {
...
Java_com_sudox_protocol_helpers_CipherHelper_encodeToBase64(JNIEnv *env, jclass type,
                                                            jbyteArray decoded) {
