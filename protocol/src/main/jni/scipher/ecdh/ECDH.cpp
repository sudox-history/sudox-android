...
Java_com_sudox_protocol_helpers_CipherHelper_calculateSecretKey(JNIEnv *env, jclass type,
...
Java_com_sudox_protocol_helpers_CipherHelper_generateKeysPair(JNIEnv *env, jclass type) {
...
Java_com_sudox_protocol_helpers_CipherHelper_removeAllKeysPairs(JNIEnv *env, jclass type) {
    removeAllKeysPairs();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_sudox_protocol_helpers_CipherHelper_removeKeysPair(JNIEnv *env, jclass type, jint pairId) {
