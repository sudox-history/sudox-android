...
class NavigationBarScreenshotLtrTest : Assert() {
    ...
    fun testButtonsPositioning() {
        ...
        navigationBar.buttonsEnd[0]!!.setText("1st")
        navigationBar.buttonsEnd[1]!!.visibility = View.VISIBLE
        navigationBar.buttonsEnd[1]!!.setText("2nd")
        navigationBar.buttonsEnd[2]!!.visibility = View.VISIBLE
        navigationBar.buttonsEnd[2]!!.setText("3rd")
