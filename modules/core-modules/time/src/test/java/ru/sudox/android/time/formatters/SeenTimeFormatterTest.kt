...
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredBetween12And24HoursAgo
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredBetween1And12HoursAgo
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredBetween1And60MinutesAgo
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredBetween2And7DaysAgo
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredInAnotherYear
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredInSameYear
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredNow
import ru.sudox.android.time.formatters.SeenTimeFormatter.onEventOccurredYesterday
import java.util.*
...
class SeenTimeFormatterTest {
    ...
    fun testWhenEventOccurredBetween2And7DaysAgo() {
        assertEquals(
            "seen on Thursday at 00:00",
            onEventOccurredBetween2And7DaysAgo(activity, 2, dateTimeOf(0L), dateTimeOf(0L), false)
        )
        assertEquals(
            "seen on Thursday at 00:00 AM",
            onEventOccurredBetween2And7DaysAgo(activity, 2, dateTimeOf(0L), dateTimeOf(0L), true)
        )
    }
    ...
    fun testWhenEventOccurredInAnotherYear() {
        assertEquals(
            "seen on jan 1 1970 at 00:00",
            onEventOccurredInAnotherYear(activity, 1, dateTimeOf(0L), dateTimeOf(31536000000L), false)
        )
        assertEquals(
            "seen on jan 1 1970 at 00:00 AM",
            onEventOccurredInAnotherYear(activity, 1, dateTimeOf(0L), dateTimeOf(31536000000L), true)
        )
    }
}