...
object ShortTimeFormatter : TimeFormatter {
    ...
    ): String = context.getString(R.string.short_formatter_years, yearsAgo)
    ...
    override fun onEventOccurredInSameYear(
        ...
        relative: LocalDateTime,
        useTwelveHoursFormat: Boolean
    ): String = context.getString(R.string.short_formatter_same_year, request.dayOfMonth, getShortNameOfMonth(context, request.month))
    ...
    override fun onEventOccurredBetween2And7DaysAgo(
        ...
        relative: LocalDateTime,
        useTwelveHoursFormat: Boolean
    ): String = getShortNameOfDayOfWeek(context, request.dayOfWeek)
    ...
    override fun onEventOccurredYesterday(
        ...
        relative: LocalDateTime,
        useTwelveHoursFormat: Boolean
    ): String = context.getString(R.string.short_formatter_yesterday)
    ...
    override fun onEventOccurredBetween12And24HoursAgo(
        ...
        relative: LocalDateTime,
        useTwelveHoursFormat: Boolean
    ): String = context.getString(R.string.short_formatter_hours, hoursAgo)
    ...
    override fun onEventOccurredBetween1And60MinutesAgo(
        ...
        relative: LocalDateTime,
        useTwelveHoursFormat: Boolean
    ): String = context.getString(R.string.short_formatter_minutes, minutesAgo)
    ...
    override fun onEventOccurredNow(
        ...
        relative: LocalDateTime,
        useTwelveHoursFormat: Boolean
    ): String = context.getString(R.string.short_formatter_now)
}