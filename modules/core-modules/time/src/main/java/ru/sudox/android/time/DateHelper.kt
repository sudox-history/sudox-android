 ...
 */
fun getShortNameOfMonth(context: Context, month: Month): String = when (month) {
 ...
 */
fun getFullNameOfMonth(context: Context, month: Month): String = when (month) {
 ...
 */
fun getShortNameOfDayOfWeek(context: Context, dayOfWeek: DayOfWeek): String = when (dayOfWeek) {
 ...
 */
fun getFullNameOfDayOfWeek(context: Context, dayOfWeek: DayOfWeek): String = when (dayOfWeek) {
